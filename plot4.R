...
par(mfrow=c(2,2))
with(data1,{
  plot(Time,Global_active_power,type="l",lwd=1,xlab="",ylab="Global Active Power")
  plot(Time,Voltage,type="l",lwd=1,xlab="datetime",ylab="Voltage")
  plot(Time,Sub_metering_1,lwd=1,xlab="",ylim=rng,ylab="Energy Sub Metering",type="l",col="black")
  par(new=TRUE)
  plot(Time,Sub_metering_2,type="l",xlab="",ylab="",ylim=rng,col="red")
  par(new=TRUE)
  plot(Time,Sub_metering_3,type="l",xlab="",ylab="",ylim=rng,col="blue")
  legend("topright",lty=1,col=c("blue","red","black"),cex=0.75,legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
  plot(Time,Global_reactive_power,type="l",lwd=1,xlab="datetime",ylab="Global_reactive_power")
})
